        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы устали наблюдать, как хорошие идеи тонут в согласованиях, очередях к дизайнерам и бесконечных правках в Figma. PromptCraft появился как ответ: создавать красивые интерфейсы должен уметь каждый — даже без навыков дизайна и кода.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы — небольшая команда инженеров и дизайнеров, которые сами прошли через всё это. Наш продукт — не очередной генератор шаблонов. Это инструмент, который думает вместе с вами.
            </p>
          </div>
        </div>
      </div>
