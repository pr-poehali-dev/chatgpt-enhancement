      ...
      >
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Пишешь.</span>{" "}
                <span className="font-serif italic">Видишь.</span>{" "}
                <span className="font-open-sans-custom not-italic">Запускаешь.</span>
              </h1>
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                опиши интерфейс словами —{" "}
                <span className="font-serif italic">ИИ соберёт</span> его за секунды. без кода, без дизайнера, без ожидания
              </p>
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Начните бесплатно. Масштабируйтесь когда будете готовы — от соло-проектов до корпоративных продуктов.
              </p>
            </div>
            <BentoPricing />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl mt-[5vh]">
            <ContactCard
              title="Напишите нам"
              description="Есть идея или вопрос? Заполните форму — мы отвечаем в течение нескольких часов и готовы обсудить любой проект."
              contactInfo={[
                {
                  icon: MailIcon,
                  label: "Почта",
                  value: "hi@promptcraft.dev",
                },
                {
                  icon: PhoneIcon,
                  label: "Телефон",
